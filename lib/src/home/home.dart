...
import 'package:proyectoryr/src/page/proyecto_r_r.dart';
import 'package:proyectoryr/src/page/reclutamientoPersonal.dart';
...
class _homeStarState extends State<homeStar> with TickerProviderStateMixin {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage('static/images/login/fondo3.png'),
                        fit: BoxFit.cover,
                      ),
                      boxShadow: <BoxShadow>[
                        BoxShadow(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (context) => proyectoR_R()));
                            },
                            child: Column(
                              children: <Widget>[
                                SizedBox(
                                ...
                                Text('Proyecto', textAlign: TextAlign.justify,  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22, color: Primary.white)),
                                Text('R & R', textAlign: TextAlign.justify,  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22, color: Primary.white))
                              ],
                            ),
                          ),
                        ),
                      ...
                      child: Container(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => reclutamientoPersonal()));
                            },
                            child: Column(
                              children: <Widget>[
                                SizedBox(
                                ...
                                Text('Tareo', textAlign: TextAlign.justify,  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22, color: Primary.white)),
                                Text('Diario', textAlign: TextAlign.justify,  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22, color: Primary.white))
                              ],
                            ),
                          ),
                        ),
