...
class proyectoR_R extends StatefulWidget {
  @override
  State<proyectoR_R> createState() => _proyectoR_RState();
}

class _proyectoR_RState extends State<proyectoR_R> with TickerProviderStateMixin {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage('static/images/fondo_spd.png'),
                        fit: BoxFit.cover,
                      ),
                      boxShadow: <BoxShadow>[
                        BoxShadow(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (context) => registrarProyectoR_R(0)));
                            },
                            child: Column(
                              children: <Widget>[
                                SizedBox(
                      ...
                      child: Container(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => listRegistrosProyectoR_R()));
                            },
                            child: Column(
                              children: <Widget>[
                                SizedBox(
